 ...
 *
 * Both constructors now build `m_value` in their ctor-initializer rather than calling
 * setters from the body. The bodies are empty - everything that needs to happen happened
 * before the brace.
 */
