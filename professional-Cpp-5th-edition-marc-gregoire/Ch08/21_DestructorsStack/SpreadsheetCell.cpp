 ...
 *
 * The destructor here only prints to the console - that is the whole point: by watching
 * the order of "Destructor called." messages the driver shows when each object dies.
 */
