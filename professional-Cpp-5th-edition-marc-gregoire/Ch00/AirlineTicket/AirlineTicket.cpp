 ...
 *
 * Each method is defined out of line as AirlineTicket::method(). The commented-out
 * constructor/destructor pair is kept only to show the syntax; with in-class initializers
 * on every data member, both would be empty boilerplate.
 *
 * calculatePriceInDollars() charges 10 cents per mile, except Elite Super Rewards customers
 * who fly free.
 */
