/*
 * Chapter 12 - SpreadsheetCell (template-friendly helper, impl)
 *
 * Standard pattern: the compound operators (`+=`, `-=`, etc.) hold the
 * actual logic; the free arithmetic operators are written in terms of
 * them. Divide-by-zero is the only validation the class does itself.
 */
