 ...
 * Notice how `moveFrom()` collapses to three lines using `exchange`.
 */
...
{
	// exchange() returns the OLD value of src.* and overwrites it with the
	// second argument in one expression - so each line takes a member and
	// simultaneously nulls/zeroes the source.
