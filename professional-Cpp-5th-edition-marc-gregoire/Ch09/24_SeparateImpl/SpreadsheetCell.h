/*
 * Chapter 9 - Stable Interface via pimpl (supporting type)
 *
 * SpreadsheetCell with full C++20 comparison support. The pimpl machinery lives
 * in Spreadsheet, not here.
 */
#pragma once
