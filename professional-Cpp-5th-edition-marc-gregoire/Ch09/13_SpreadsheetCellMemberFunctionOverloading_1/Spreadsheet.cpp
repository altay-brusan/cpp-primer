 ...
 * Watch the non-const getCellAt below collapse to a single forwarding call.
 */
...
{
	// View *this as const, call the const overload, then strip the const off the
	// returned reference. Safe because *this is genuinely non-const here.
