/*
 * Chapter 9 - Defaulted Comparisons Plus Explicit double Version (driver)
 *
 * Same battery of comparisons as folders 5 and 6, but the `double` operands now
 * hit the explicit overloads directly instead of constructing a throwaway
 * SpreadsheetCell.
 */
