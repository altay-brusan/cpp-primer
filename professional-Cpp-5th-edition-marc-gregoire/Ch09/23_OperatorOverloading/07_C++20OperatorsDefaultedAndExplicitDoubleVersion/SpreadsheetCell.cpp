/*
 * Chapter 9 - C++20 Defaulted Comparisons Plus Explicit double Version
 *
 * Implementation for SpreadsheetCell.h - see the header for the conceptual notes.
 * Only the explicit `double` overloads have bodies here; the cell-vs-cell ones
 * are still defaulted in the header.
 */
