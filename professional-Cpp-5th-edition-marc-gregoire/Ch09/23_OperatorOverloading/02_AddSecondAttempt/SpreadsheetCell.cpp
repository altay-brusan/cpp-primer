 ...
 * The commented-out `operator+(double rhs) const` shows the explicit overload that
 * would avoid creating a temporary SpreadsheetCell when adding a plain double.
 */
