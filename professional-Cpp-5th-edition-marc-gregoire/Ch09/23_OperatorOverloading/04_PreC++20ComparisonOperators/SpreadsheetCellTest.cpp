/*
 * Chapter 9 - Pre-C++20 Comparison Operators (driver)
 *
 * Exercises both lvalue-vs-lvalue cell comparison and the implicit-conversion
 * forms like `myCell < 10`. Each call resolves to one of the six handwritten
