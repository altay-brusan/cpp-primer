/*
 * Chapter 9 - C++20 Comparison Operators (driver)
 *
 * Pushes every comparison combination through the spaceship-and-equality pair.
 * Note how `10 == myCell`, `10 < myCell`, and `10 != myCell` all work despite the
 * member operators only handling the SpreadsheetCell-on-the-left case - the
 * compiler rewrites them.
 */
