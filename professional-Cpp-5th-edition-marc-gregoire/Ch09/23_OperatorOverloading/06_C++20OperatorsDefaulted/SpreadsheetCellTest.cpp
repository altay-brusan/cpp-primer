/*
 * Chapter 9 - C++20 Defaulted Comparison Operators (driver)
 *
 * Identical exercise as folder 05, but the operator bodies are generated by the
 * compiler. The behavior is unchanged; the maintenance burden drops to zero.
 */
