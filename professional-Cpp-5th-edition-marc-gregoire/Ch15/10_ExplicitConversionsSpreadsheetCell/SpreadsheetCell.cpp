/*
 * Chapter 15 - Explicit Conversion Operators (implementation)
 *
 * Implementation for SpreadsheetCell.h - see the header for the conceptual notes.
 * The bodies of operator double() and operator std::string() are identical to sample 08;
 * only the explicit keyword on the double conversion (in the header) differs.
 */
