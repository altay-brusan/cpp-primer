/*
 * Chapter 15 - Supporting SpreadsheetCell (implementation)
 *
 * Implementation for SpreadsheetCell.h - see the header for the conceptual notes.
 * This is the plain arithmetic SpreadsheetCell used as the pointee type in the
 * dereferencing-operator example; it adds nothing beyond the operators from sample 01.
 */
