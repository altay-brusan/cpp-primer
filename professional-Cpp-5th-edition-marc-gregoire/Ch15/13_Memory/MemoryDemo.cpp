/*
 * Chapter 15 - Overloading new and delete (implementation)
 *
 * Implementation for MemoryDemo.h - see the header for the conceptual notes.
 * Each overload simply prints which form was called and then forwards to the global
 * ::operator new / ::operator delete, illustrating the mechanics without a real allocator.
 */
