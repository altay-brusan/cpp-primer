/*
 * Chapter 15 - Writing Conversion Operators (implementation)
 *
 * Implementation for SpreadsheetCell.h - see the header for the conceptual notes.
 * operator double() just returns the stored value; operator std::string() formats it via
 * doubleToString(). The remaining arithmetic operators are unchanged from sample 01.
 */
