/*
 * Chapter 15 - Overloading the Arithmetic Operators (implementation)
 *
 * Implementation for SpreadsheetCell.h - see the header for the conceptual notes.
 * Note how each binary operator (+, -, *, /) makes a local copy and forwards to the
 * corresponding compound-assignment member, and how postfix ++/-- save a copy, call the
 * prefix form, and return the saved old value.
 */
