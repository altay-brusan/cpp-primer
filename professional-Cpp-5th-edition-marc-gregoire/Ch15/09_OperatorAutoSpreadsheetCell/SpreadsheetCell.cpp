/*
 * Chapter 15 - Conversion Operators with operator auto (implementation)
 *
 * Implementation for SpreadsheetCell.h - see the header for the conceptual notes.
 * The operator auto() body lives in the header (return-type deduction requires it);
 * only operator std::string() and the arithmetic operators are implemented here.
 */
