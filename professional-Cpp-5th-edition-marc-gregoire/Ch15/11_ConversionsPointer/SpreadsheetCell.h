 ...
 * operator std::string()), reused here only as the type pointed to by the Pointer smart
 * pointer. The feature of interest in this folder - the operator void* Boolean
 * conversion on the smart pointer itself - lives in Pointer.h.
 */
#pragma once
