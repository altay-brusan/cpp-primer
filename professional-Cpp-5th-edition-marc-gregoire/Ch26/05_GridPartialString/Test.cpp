/*
 * Chapter 26 - Choosing Primary Template vs Partial Specialization
 *
 * Instantiates Grid<int, 2, 2> (which selects the primary template) and
 * Grid<const char*, 2, 2> (which selects the partial specialization), and
 * copies a string grid to confirm the specialization stores owning strings.
 */
