/*
 * Chapter 26 - Primary Template for the Pointer Partial Specialization
 *
 * The ordinary single-parameter Grid storing optional<T> values in a vector.
 * It is the primary template against which GridPtr.h provides a partial
 * specialization covering all pointer element types.
 */
