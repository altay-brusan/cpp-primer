/*
 * Chapter 26 - Verifying Deep-Copy Behavior of the Pointer Specialization
 *
 * Uses Grid<int> (primary template) and Grid<int*> (pointer specialization),
 * then copies a pointer grid and modifies one copy to demonstrate that the
 * specialization makes independent deep copies of the owned objects.
 */
