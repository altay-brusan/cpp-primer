/*
 * Chapter 18 - Inserting into a map
 *
 * Demonstrates insert(), whose return is a pair<iterator, bool> reporting
 * whether a new key was added (insert never overwrites an existing key). Shows
 * checking that bool, combining it with C++17 if-initializers and structured
 * bindings, insert_or_assign() (which does overwrite), and C++23
 * insert_range().
 */
