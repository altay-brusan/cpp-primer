/*
 * Chapter 18 - Adding and Removing vector Elements
 *
 * Exercises the element-modifying methods: the several forms of insert()
 * (single value at a position, a value n times, and an iterator range),
 * push_back(), the C++23 append_range(), the two-iterator erase(), clear(),
 * and pop_back(). Iterator positions are given with cbegin() and cend() plus
 * offsets, exploiting random-access arithmetic.
 */
