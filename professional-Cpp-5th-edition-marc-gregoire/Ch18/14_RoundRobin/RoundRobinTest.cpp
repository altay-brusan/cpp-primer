/*
 * Chapter 18 - RoundRobin Demo: A Process Scheduler
 *
 * Driver for the RoundRobin class template - see RoundRobin.h for the
 * conceptual notes. Defines a Process class and a Scheduler that cycles through
 * processes with RoundRobin, giving each a time slice and demonstrating removal
 * mid-cycle. Process defines a defaulted operator== so RoundRobin::remove() can
 * find elements.
 */
