 ...
 *
 * Each method is defined out of line as AirlineTicket::method(). calculatePriceInDollars()
 * charges 10 cents per mile, but Elite Super Rewards customers fly free.
 */
